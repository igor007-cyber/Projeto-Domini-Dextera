...
namespace surfplace
{
    public class Startup
    {
        ...
        {
            services.AddCors();
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("oxidu")));
            ...
            services.AddScoped(typeof(IAspNetUsersCompanyRepository), typeof(AspNetUsersCompanyRepository));
